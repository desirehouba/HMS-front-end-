...
import { OrdersService } from '../../cashIns.service';
import {
  UntypedFormControl,
  Validators,
  UntypedFormGroup,
...
import { Orders } from 'src/app/core/models/cashIns.model';
...
export class OrdersDialogComponent {
  ...
  constructor(
    ...
    public cashInsService: OrdersService,
    private fb: UntypedFormBuilder,
    private authService : AuthService,
    private servicesService : ServicesService
  ) {
    this.dialogTitle = data.cashIns.name;
    this.cashIns = data.cashIns;
    
    this.cashInForm = this.createContactForm();
  }
  ...
  createContactForm(): UntypedFormGroup {
    return this.fb.group({
      id: [this.cashIns.id],
      name: [this.cashIns.name],
      description: [this.cashIns.description],
      level: [this.cashIns.levels],
      libelle: [this.cashIns.libelle],
      code: [this.cashIns.code],
      assessment: [this.cashIns.assessment],
  ...
  getAssessment(){
    if (
      this.cashInForm.get("assessment")?.value === true
    ) {
      this.stat = true;
    } else{
      this.stat = false;
  ...
  updateOrders() {
    ...
    const cashInData = {
      ...
      idSchool : this.cashIns.idSchool,
      idSection : this.cashIns.idSection,
    };
