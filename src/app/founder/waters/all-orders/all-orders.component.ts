  ...
  implements OnInit
{
  ...
  constructor(
    ...
    this.orderForm = this.fb.group({
      payment_status: [localStorage.getItem('payment_status_water') ? JSON.parse(localStorage.getItem('payment_status_water') || '') : ''],
      status: [localStorage.getItem('status_water') ? JSON.parse(localStorage.getItem('status_water') || '') : ''],
  ...
  addNew() { 
    this.router.navigate([
      "/founder/waters/all-orders/add-order"
    ]);
  }
  ...
  setDate(i: boolean) {
      if (i === true) {
        localStorage.setItem('date_start_order_water', formatDate(this.orderForm.controls['date_start'].value,'YYYY-MM-dd', 'en-US'));
        localStorage.setItem('date_end_order_water', formatDate(this.orderForm.controls['date_end'].value,'YYYY-MM-dd', 'en-US'));
      } else {
        localStorage.setItem('date_start_order_water', '');
        localStorage.setItem('date_end_order_water', '');
      }
      this.loadData();
    }
  ...
  setStatus() {
    if (this.f["status"].value != null) {
      localStorage.setItem('status_water', JSON.stringify(this.f["status"].value));
    } else {
      localStorage.setItem('status_water', JSON.stringify(null));
    }
    this.ngOnInit();
  }
  ...
  setStatusPayment() {
    if (this.f["payment_status"].value != null) {
      localStorage.setItem('payment_status_water', JSON.stringify(this.f["payment_status"].value));
    } else {
      localStorage.setItem('payment_status_water', JSON.stringify(null));
    }
    this.ngOnInit();
  } 
